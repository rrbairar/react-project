                ...
                <Modal show={this.state.showHide} centered>
                    <Modal.Body>
                      <div className="popup_app_details">
                        <img src={this.props.appImg} className="game_img" alt="game" />
                        <div className="app_name_detail">
                          <p className="margin-0">{this.props.isGameName}</p>
                          <p className="country_name margin-0">{this.props.appCountry}</p>
                        </div>
                      </div>
                      <div>
